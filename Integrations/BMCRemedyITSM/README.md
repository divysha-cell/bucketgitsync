...
|Status|Specify the status for the incident. Note: if status is "Pending" or "Resolved", then you also need to provide "Status Reason" value.||List|Select One|
|Status Reason|Specify the status reason for the incident.||String||
|Impact|Specify the impact for the incident.||List|Select One|
|Urgency|Specify the urgency for the incident.||List|Select One|
|Description|Specify the description of the incident||String||
|Incident Type|Specify the incident type for the incident.||List|Select One|
|Assigned Group|Specify the assigned group for the incident||String||
|Assignee|Specify the assignee for the incident||String||
|Resolution|Specify the resolution for the incident.||String||
|Resolution Category Tier 1|Specify the resolution category tier 1 for the incident.||String||
|Resolution Category Tier 2|Specify the resolution category tier 2 for the incident.||String||
|Resolution Category Tier 3|Specify the resolution category tier 3 for the incident.||String||
|Resolution Product Category Tier 1|Specify the resolution category tier 1 for the incident.||String||
|Resolution Product Category Tier 2|Specify the resolution category tier 2 for the incident.||String||
|Resolution Product Category Tier 3|Specify the resolution category tier 3 for the incident.||String||
|Reported Source|Specify the reported source.||List|Select One|
|Custom Fields|Specify a JSON object containing all of the needed fields and  values that need to be updated. Note: this parameter will overwrite other provided parameters.||String||
...
|----|-----------|-----------|----|------------|
|Incident ID|Specify the ID of the incident that needs to be updated.|True|String||
|Status|Specify what is the expected status for the incident.||List|Select One|
|Fields To Check|Specify a JSON object containing all of the needed fields and values. Note: this parameter has priority over "Status" field.||String|{"field":"value"}|
|Fail If Timeout|If enabled, action will be failed, if not all of the fields were updated.||Boolean|true|
...
|Urgency|Specify the urgency for the incident.||List|Select One|
|Description|Specify the description of the incident||String||
|Company|Specify the company for the incident||String||
|Customer|Specify the customer for the incident. Note: Customer needs to be provide in the format "{Last Name} {First Name}". Example: Allbrook Allen.||String||
|Template Name|Specify the name of the template for the incident. Note: action will try to find the ID of the template in the background. For better precision you can provide the template ID directly via Custom Fields.||String||
|Incident Type|Specify the incident type for the incident.||List|Select One|
|Assigned Group|Specify the assigned group for the incident||String||
|Assignee|Specify the assignee for the incident||String||
|Resolution|Specify the resolution for the incident.||String||
...
|Resolution Product Category Tier 3|Specify the resolution category tier 3 for the incident.||String||
|Reported Source|Specify the reported source||List|Select One|
|Custom Fields|Specify a JSON object containing all of the needed fields and  values that need to be used during the creation. Note: this parameter will overwrite other provided parameters.||String||
...
|Fields To Return|Specify what fields to return. If invalid fields are provided, action will fail. If nothing is provided, action will return all fields.||String||
|Fetch Work Notes|If enabled, action will return work notes related to the incident.||Boolean|true|
|Max Work Notes To Return|Specify how many Work Notes to return. If nothing is provided, action will return 50 Work Notes.||String|50|
