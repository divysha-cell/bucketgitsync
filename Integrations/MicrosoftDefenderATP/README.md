...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Severity Filter|The severity levels used to filter the returned vulnerabilities.|False|21|Critical|
|Threat Filter|The threat intelligence criteria used to filter the returned vulnerabilities.|False|21||
