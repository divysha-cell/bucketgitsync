...
|Graph API Root|The base URL for the Microsoft Graph API (e.g., https://graph.microsoft.com). If provided, V2 API endpoints will be used.||String||
...
|Application|Specify an application that is related to the entities.||String||
...
|Recommended Action|Specify what should be the recommended actions for the handling of the entities.||String||
...
|Status|Status of the alert||List|New|
|Assigned To|User who is assigned to this alert||String|None|
|Classification|Classification to update alert with||List|Unknown|
|Determination|Determination to update alert with||List|NotAvailable|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Status|Statuses of the alert to look for. Comma-separated string||String|None|
|Severity|Severities of the alert to look for. Comma-separated string.||String|None|
|Category|Categories of the alert to look for. Comma-separated string.||String|None|
|Incident ID|Microsoft Defender Incident ID for which you want to find related alerts.||String|None|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Machine Name|Full Machine Name to look for||String|None|
|Machine IP Address|Machine IP Address to look for||String|None|
|Machine Risk Score|Machine risk score to look for. Comma-separated string.||String|None|
|Machine Health Status|Machine health status to look for. Comma-separated string||String|None|
|Machine OS Platform|Machine OS platform to look for.||String|None|
|RBAC Group ID|RBAC Group ID to look for.||String|None|
...
|Comment|Comment that describes the executed command.||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Severity Filter|The severity levels used to filter the returned vulnerabilities.||None|None|
|Threat Filter|The threat intelligence criteria used to filter the returned vulnerabilities.||None|None|
|Sort By|The field used to sort the returned vulnerabilities.||List|None|
|Sort Order|The order in which the sorted results are displayed.||List|None|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Time Frame|Time frame in hours for which to fetch Alerts||String|None|
|Status|Statuses of the alert to look for. Comma-separated string||String|None|
|Severity|Severities of the alert to look for. Comma-separated string.||String|None|
|Category|Categories of the alert to look for. Comma-separated string.||String|None|
|Incident ID|Microsoft Defender Incident ID for which you want to find related alerts.||String|None|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Indicators|Specify a comma-separated list of indicators that you would like to retrieve.||String||
|Indicator Types|Specify a comma-separated list of indicator types that you want to retrieve. Possible values: FileSha1, FileSha256, FileMd5, CertificateThumbprint, IpAddress, DomainName, Url.||String|FileSha1,FileSha256,FileMd5,CertificateThumbprint,IpAddress,DomainName,Url|
|Actions|Specify a comma-separated list of indicator actions that you want to use for filtering. Possible values: Warn,Block,Audit,Alert,AlertAndBlock,BlockAndRemediate,Allowed.||String|Warn,Block,Audit,Alert,AlertAndBlock,BlockAndRemediate,Allowed|
|Severity|Specify a comma-separated list of severities that you want to use for filtering. Possible values: Informational,Low,Medium,High.||String|Informational,Low,Medium,High|
|Max Results To Return|Specify how many indicators to return. Default: 50.||String|50|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Last Seen Time Frame|Time frame in hours for which to fetch Machines||String|None|
|Machine Name|Full Machine Name to look for||String|None|
|Machine IP Address|Machine IP Address to look for||String|None|
|Machine Risk Score|Machine risk score to look for. Comma-separated string.||String|None|
|Machine Health Status|Machine health status to look for. Comma-separated string||String|None|
...
|EventClassId|The field name used to determine the event name (sub-type)||String|category|
