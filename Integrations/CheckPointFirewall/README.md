<p align="center"><img src="./Resources/CheckPointFirewall.svg" 
     alt="CheckPointFirewall" width="200"/></p>
...
|----|-----------|-----------|----|------------|
|Server Address|None|True|IP|xx.xx.xx.xx:443|
|Username|None|True|String||
|Domain|None||String||
|Password|None|True|Password|*****|
|Policy Name|None|True|String|standard|
|Verify SSL|None||Boolean|None|
...
|Create Case Wall Attachment|If enabled, action will create a case wall attachment for each successfully downloaded file. Note: that attachment will only be created if it’s size is less than 3 MB.||Boolean||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Max Policies To Return|Specify how many policies to return in the response. Default: 50.||String|50|
...
|Source IP|Specify the source IP to be added to the rule.||String||
|Source Netmask|Specify the source netmask to be added to the rule.||String||
|Destination IP|Specify the destination IP to be added to the rule.||String||
|Destination Netmask|Specify the destination netmask to be added to the rule.||String||
|Port|Specify the port number to be added to the rule for example, 5005||String||
|Protocol|Specify the protocol name to be added to the rule for example, TCP||String||
...
|Close Connections|Specify if the existing matching connections should be closed.||Boolean|false|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Query Filter|Specify the query filter that will be used to return logs.||String||
...
|Max Logs To Return|Specify how many logs to return. Maximum is 100. This is Checkpoint FireWall limitation.||String|50|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Max Layers To Return|Specify how many layers to return in the response. Default: 50.||String|50|
...
|Port|Specify the port number to be added to the rule for example, 5005||String||
|Protocol|Specify the protocol name to be added to the rule for example, TCP||String||
|Expiration|Specify how long in seconds the newly added SAM rule should be active for example, 4. If nothing is specified - then the rule never expires.||String||
|Action for the Matching Connections|Specify the action that should be executed for the matching connections.|True|List|Drop|
|How to Track Matching Connections|Specify how to track matching connections.|True|List|Log|
|Close Connections|Specify if the existing matching connections should be closed.||Boolean|false|
