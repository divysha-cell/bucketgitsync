...
|Verify SSL|Verify SSL when making requests||Boolean|false|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Task Name|The name of the task. If the parameter is not passed, the name will be automatically generated.||String|None|
...
|Custom Scan - Depth|The scan profile. Available options: 1 - aggressive; 2 - normal; 3 - permissive. This parameter is only used when scan type is Custom||List|Normal|
|Custom Scan - Paths|Comma-separated list of target paths to be scanned. This parameter is only used when scan type is Custom||String|LocalDrives|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Parent ID|Parent group ID for which the child groups will be listed. 'Computers and Groups' and 'Deleted' groups are returned if the passed parameter is null.||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Filter - SSID|The SSID (Active Directory SID of the endpoint) used to filter the endpoints regardless of their protection status.||String|None|
|Filter - Depth - All Items Recursively|Boolean to filter all endpoints recursively within the Network Inventory of a company.||Boolean|false|
|Filter - Security Servers|Boolean to filter all Security Servers||Boolean|false|
|Filter - Managed Relays|Boolean to filter all endpoints with Relay role. ||Boolean|false|
|Filter - Managed Exchange Servers|Boolean to filter all protected Exchange servers.||Boolean|false|
|Parent ID|The ID of the target company or group. If not specified or set with a company ID, the method returns only the endpoints under Computers and Groups.||String|None|
|Endpoints|Select whether to return only managed endpoints, unmanaged endpoints, or all endpoints.|True|List|All|
|Filter - Managed with BEST|Boolean to filter all endpoints with the security agent installed on them.||Boolean|false|
|Filter - Name|A string for filtering the items by name. Minimum required string length is three characters.||String|None|
|Filter - MAC Addresses|Comma-separated list of MAC addresses used to filter the endpoints regardless of their protection status.||String|None|
...
|Task Name|Use an asterisk in front to search its appearance anywhere in the name. If omitted, only returns results where the name starts with the keyword||String|None|
...
|----|-----------|-----------|----|------------|
|Service|Allowed services are: computers, for "Computers and Virtual Machines" or exchange, for "Security for Exchange"|True|List|Computers|
|Filter - Threat Name|Filters the quarantined items by threat name.This filter is available for computers and exchange services.||String|None|
|Filter - Start Date|Filters the items that quarantined after the specified date. Format for startDate is in ISO 8601.The filter is available for computers and exchange.||String|None|
|Filter - End Date|Filters the items quarantined before the specified date.Format for startDate is in ISO 8601.The filter is available for computers and exchange.||String|None|
|Filter - File Path|Filters the quarantined items by file path. This filter is available for computers service.||String|None|
|Filter - IP Address|Filters the quarantine items by IP address. This filter is available for computers service.||String|None|
|Filter - Action Status|Filters the quarantine items by action status. "Pending Save" Is only available to the Exchange Service.||List|None|
|Endpoint ID|ID of the computer for which you want to retrieve the quarantined items. If not passed, he method returns the items quarantined in the entire network.||String|None|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Location to Restore|The absolute path to the folder where the items will be restored. If the parameter is not set, the original location will be used.||String|None|
|Quarantine Item IDs|Comma-separated list of quarantine items IDs. The maximum number of items that can be removed once is 100.|True|String|itemId1,itemId2|
|Service|Allowed services are: computers, for "Computers and Virtual Machines" or exchange, for "Security for Exchange"|True|List|Computers|
|Add Exclusion in Policy|Exclude the files to be restored from future scans. Exclusions do not apply to items with the Default Policy assigned.||Boolean|false|
...
|Filter - Managed Exchange Servers|Boolean to filter all protected Exchange servers.||Boolean|false|
|Filter - Managed with BEST|Boolean to filter all endpoints with the security agent installed on them.||Boolean|false|
|Filter - Virtual Machines|Boolean to filter all virtual machines.||Boolean|false|
|Filter - Computers|Boolean to filter all computers.||Boolean|false|
|Filter - EC2 Instances|Boolean to filter all Amazon EC2 Instances.||Boolean|false|
|Filter - Groups|Boolean to filter all custom groups of endpoints.||Boolean|false|
|Parent ID|The ID of the container for which the network items will be returned.||String|None|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|EWS URL|The Exchange Web Services URL .The EWS URL is necessary when the Exchange Autodiscovery does not work.||String|None|
|Email|The email address of the Exchange user. This parameter is necessary when the email address is different from the username.||String|None|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Report Name|The name of the report.||String|None|
|Report Type|The report type.||List||
