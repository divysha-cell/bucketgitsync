...
class Cache(MutableMapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    def __init__(self, context_handler: Context, key_prefix: str = "name_to_modification_time_mapping") -> None:
    ...
    def _row_key(self, _i: _Index) -> str:
        return f"{self._key_prefix}{_i}"
