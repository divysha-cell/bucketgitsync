...
|Organization ID|ID of the organization that can be used with the Cloud Recommender integration.||String||
|Project ID|ID of the project that should be used in the integration. Takes priority over Organization ID, if both are provided.||String||
...
|User's Service Account|Service account of the Google Recommender service. A full content of the service account JSON file should be provided. This or "Workload Identity Email" must be provided.||Password|*****|
|Verify SSL|If enabled, verify the SSL certificate for the connection to the Google Recommender service is valid.||Boolean|true|
...
|Recommendation State|Specify the state for the recommendation to change to.||List|Not Specified|
|Recommendation Result|Specify the result for the recommendation to change to.||List|Not Specified|
...
|Recommendation State|Specify the recommendation state to return.||List|Not Specified|
|Recommendation Priority|Specify the recommender priority to return, multiple values can be specified as a comma separated string.||String||
|Recommender Subtype|Specify the recommender subtype to return.||List|Not Specified|
