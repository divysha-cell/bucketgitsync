...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|User Email Addresses|Specify a comma-separated list of email addresses for which you want to return the users.||String||
|User Names|Specify a comma-separated list of user display names for which you want to return the users.||String||
|Project|Specify the name of the project in which you need to search for the email addresses. If provided, only Project Assignable Users will be returned. ||String||
...
|Download Path|Specify the path for the downloaded file. Note: if parameter 'Download Attachments to the Case Wall' is enabled, then this parameter is not mandatory.||String||
|Download Attachments to the Case Wall|If enabled, action download Jira issue attachmnets to the current Siemplify alert case wall.||Boolean|False|
...
|Jira Username|The Jira username of the initiator of the action. Note: If a username is not provided, action will not create a comment in the issue||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Project Names|The names of the projects to search in, comma separated||String||
|Summary|The summary to filter by||String||
|Description|The description to filter by||String||
|Issue Types|The issue types to filter by||String||
|Priorities|The priority to filter by||String||
|Created From|The earliest creation date to filter by. Format: YYYY/MM/DD. If not provided, filter will not be used.||String|YYYY/MM/DD|
|Updated From|The earliest update date to filter by. Format: YYYY/MM/DD. If not provided, filter will not be used.||String|YYYY/MM/DD|
|Assignees|The name of the assignees to filter by, comma separated||String||
|Reporter|The name of the reporters to filter by, comma separated||String||
|Statuses|The statuses to filter by, comma separated||String||
...
|Jira Username|The Jira username of the initiator of the action. Note: If a username is not provided, action will not create a comment in the issue||String||
|Assignee|The new assignee of the issue.||String||
|Components|The Components field of the issue. Parameter accepts multiple values as a comma separated string.||String||
|Labels|The Labels field of the issue. Parameter accepts multiple values as a comma separated string.||String||
|Custom Fields|Specify a JSON object containing all of the fields and values that will be used during issue creation. Note: this parameter has priority and all of the fields will be overwritten with the value that is provided for this parameter. Example: {"field":"value"}||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Filter Key|Specify the key that needs to be used to filter {item type}.||List|Select One|
...
|Status|Specify the relevant transition name, to transition this issue to the new desired status.||String|Done|
|Summary|The new summary of the issue||String||
|Description|The new description of the issue||String||
|Issue Type|The new type of the issue||String||
|Jira Username|The JIRA username of the action initiator. Note: If a username is not provided, action will not create a comment in the issue||String||
|Assignee|The new assignee of the issue.||String||
|Components|The Components field of the issue. Parameter accepts multiple values as a comma separated string.||String||
|Labels|The Labels field of the issue. Parameter accepts multiple values as a comma separated string.||String||
|Custom Fields|Specify a JSON object containing all of the fields and values that will be updated for the issue. Note: this parameter has priority and all of the fields will be overwritten with the value that is provided for this parameter. Example: {"field":"value"}||String||
...
|EventClassId|The field name used to determine the event name (sub-type)||String|issuetype_name|
...
|Use Jira Project as Environment|Use Jira project as environment else use Environment Field Name as environment.||Boolean|true|
...
|Days Backwards|Max number of days backwards to pull alerts from||Integer|5|
|Max Tickets Per Cycle|Max tickets to fetch and process in one connector cycle||Integer|10|
|Verify SSL|If enabled, verify the SSL certificate for the connection to Jira server is valid.||Boolean|false|
|Project Names|Project names separated by comma||String||
|Issue Statuses|Issue statuses separated by comma||String||
|Assignees|Users full names separated by comma||String||
|Issue Types|Issue types separated by comma||String||
|Issue Priorities|Issue priorities separated by comma||String||
|Issue Components|Issue components separated by comma||String||
