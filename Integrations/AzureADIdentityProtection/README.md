...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Create Insights|If enabled, action will create an insight containing all of the retrieved information about the entity.||Boolean|true|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|State|Specify the state for the users.||List|Compromised|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Verify SSL|If enabled, verify the SSL certificate for the connection to the Azure AD Identity Protection server is valid.||Boolean|true|
...
|Login API Root|Login API root of the Azure AD Identity Protection instance.||String|https://login.microsoftonline.com|
...
|Lowest Risk Level To Fetch|Lowest risk that needs to be used to fetch alerts. Possible values: Low, Medium, High. If nothing is specified, the connector will ingest risk detections with all risk levels.||String||
...
|Max Alerts To Fetch|How many alerts to process per one connector iteration. Default: 100.||Integer|100|
