...
|EventClassId|Enter the source field name in order to retrieve the Event Field name.|True|String|indicators_field|
...
|Max Alerts To Fetch|How many alerts to process per one connector iteration. Default: 10.|False|Integer|10|
