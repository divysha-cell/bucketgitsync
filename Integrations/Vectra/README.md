...
|EventClassId|Enter the source field name in order to retrieve the Event Field name.|True|String|detection_detection_category|
...
|Lowest Threat Score To Fetch|Lowest threat score that will be used to fetch detections. Min:0 Max:100|True|Integer|50|
|Lowest Certainty Score To Fetch|Lowest certainty score that will be used to fetch detections. Min: 0 Max: 100|False|Integer|0|
...
|Max Detections To Fetch|How many detections to process per one connector iteration. Limit is 5000. This is a Vectra limitation.|False|Integer|25|
