...
|User's Service Account|Service account of the Google Cloud Policy Intelligence instance. A full content of the service account JSON file should be provided.|False|Password|*****|
