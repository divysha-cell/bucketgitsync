...
|Verify SSL|If selected, the integration validates the SSL certificate when connecting to Akamai. Selected by default.||Boolean|true|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Network List Name|Name of the network list that needs to be updated. If both "Network List Name" and "Network List ID" are provided, action will work with ID.||String||
|Network List ID|ID of the network list that needs to be updated. If both "Network List Name" and "Network List ID" are provided, action will work with ID.||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Client List Name|Name of the client list that needs to be updated. If both "Client List Name" and "Client List ID" are provided, action will work with ID.||String||
|Client List ID|ID of the client list that needs to be updated. If both "Client List Name" and "Client List ID" are provided, action will work with ID.||String||
|Item Value|Comma-separated list of items that need to be added to the client list.|True|String||
|Item Description|Description for the items that will be added to the client list.||String||
|Item Expiration Date|Expiration date for the added items. Expected format: ISO 8601.||String||
|Item Tags|Comma-separated list of tags for the added items.||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Client List Name|The name of the client list to activate. If both Client List Name and Client List ID are provided, the action prioritizes Client List ID.||String||
|Client List ID|The unique identifier of the client list to activate. If both Client List Name and Client List ID are provided, the action prioritizes Client List ID.||String||
|Environment|The target network environment for the activation.||List|Production|
|Comment|A brief description or justification associated with the activation operation.||String||
|Notification Recipients|A comma-separated list of email addresses that receive a notification regarding the client list activation.||String||
...
|Network List Name|Name of the network list that needs to be updated. If both "Network List Name" and "Network List ID" are provided, action will work with ID.||String||
|Network List ID|ID of the network list that needs to be updated. If both "Network List Name" and "Network List ID" are provided, action will work with ID.||String||
|Environment|Environment for which the activation status should be returned.||List|Production|
|Comment|A comment that will be associated with activation operation.||String||
|Notification Recipients|Comma-separated list of emails that should receive the notification about activation of network list.||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Client List Name|Comma-separated list of client list names that you want to search for.||String||
|Client List ID|Comma-separated list of client list ids that you want to search for.||String||
|Include Items|If enabled, action will return information about items inside the client list. Note: this information is only returned, if either “Client List Name” or “Client List ID” is provided.||Boolean|false|
|Type|Type of the client list that needs to be searched. If Select One is provided, action will search among all client lists.||List|Select One|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Network List Name|Comma-separated list of network list names that you want to search for.||String||
|Network List ID|Comma-separated list of network list ids that you want to search for.||String||
|Include Items|If enabled, action will return information about items inside the network lists.||Boolean|false|
|Include Activation Status|If enabled, action will return information about activation status. Note: this information is only returned, if either "Network List Name" or "Network List ID" is provided.||Boolean|false|
|Activation Environment|Environment for which the activation status should be returned. Only returned, if you provide a specific Network List Name/Network List ID.||List|Both|
