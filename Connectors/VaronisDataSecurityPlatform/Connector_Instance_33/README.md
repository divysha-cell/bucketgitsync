# Connector_Instance_33
Automated connector 33
...
If the environment field isn't found, the environment is "".|False||
...
|Username|Specify the username to connect with.|True|dummy_val|
...
|Proxy Server Address|Proxy server to use for connection to the mail server.|False||
