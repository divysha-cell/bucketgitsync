...
|----|-----------|------------|-----|
|Server Address|Server address of the ArcSight instance|True|https://127.0.0.1|
|Username|Username of the ArcSight account|True|dummy_valid_string|
...
|Secondary Device Product Field|Secondary field for Device Product|False|dummy_valid_string|
|Alert Custom Fields Names|Additional fields that should be added to Siemplify Alert. Example: source_address|False|dummy_valid_string|
