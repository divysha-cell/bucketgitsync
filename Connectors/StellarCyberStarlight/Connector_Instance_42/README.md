# Connector_Instance_42
Automated connector 42
...
|API Root|API Root of the Stellar Cyber Starlight instance.|True|https://{ip}/connect/api/|
|Username|Username of the Stellar Cyber Starlight account.|True|dummy_val|
