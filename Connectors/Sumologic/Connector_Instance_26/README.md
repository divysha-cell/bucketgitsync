# Connector_Instance_26
Automated connector 26
...
|----|-----------|------------|-----|
|Api Root|The Sumologic Api root, i.e: https://api.{region}.sumologic.com|True|dummy_val|
|Access ID|Sumologic access ID|False||
...
|Environment Field|The name of the field where the environment is located (flat field path). e.g. _collector|False||
