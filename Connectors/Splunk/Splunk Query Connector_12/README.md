...
|Environment Field Name|Field which represent the environment in the event data.|False|0|
|Rule Generator Field|Field that represents the rule generator field.|True|0|
|Alert Name Field Name|Field which represent the alert name.|True|0|
