# Connector_Instance_24
Automated connector 24
...
|Priority Filter|Priority filter for the incidents. If you want to ingest all of the incidents specify: Low, Medium, High.|True|4|
