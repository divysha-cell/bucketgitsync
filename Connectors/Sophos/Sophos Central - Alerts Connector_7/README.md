# Sophos Central - Alerts Connector_7
...
|Lowest Severity To Fetch|Severity that will be used to fetch alerts. If nothing is specified, action will ingest all alerts. Possible values: Low, Medium, High.|False|0|
