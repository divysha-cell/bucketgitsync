...
|API Root|API Root of the FireEye Helix instance. Example: https://helix.eu.fireeye.com/helix/id/aaaqsj477/|True|https://127.0.0.1|
|API Token|API Token of the FireEye Helix account.|True|*****|
|Server Timezone|Specify which timezone is set on the FireEye Helix server in regards to UTC. For example, +1, -1, etc. If nothing is specified, the connector will use UTC as a default timezone.|False|https://127.0.0.1|
